...
All notable changes to AXTURION (Modular Application Tracking System) will be documented in this file.
...
AXTURION follows an incremental, architecture-first release strategy.
...
AXTURION is built as a long-term modernization platform, not a feature-driven startup MVP.
...
## Why is AXTURION still < 1.0?

AXTURION is currently in the 0.x phase because we are deliberately stabilizing the architectural foundation before declaring production maturity.
