AXTURION Technical Roadmap

This document outlines the technical evolution path of AXTURION from v0.4.0 toward v1.0.

AXTURION is positioned as governance-grade recruitment infrastructure,
...
AXTURION evolves infrastructure first.
