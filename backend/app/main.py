...
from app.api.routes import applications, activity, workflows, workflow_queries
...
app.include_router(workflow_queries.router, prefix="/workflow-queries", tags=["workflow-queries"])
